...
project_folder_path = '../NeuroConText_v2_parent_folder/NeuroConText_v2_child_folder'

# Path to the parent directory
# parent_folder_path = '/data/parietal/store3/work/fghayyem/projects/MICCAI_2024/'
parent_folder_path = '../NeuroConText_v2_parent_folder'
...
from layers import ClipModel, ClipModel_autoencoder, MLP, ProjectionHead, ResidualHead, ProjectionHead_decoder, ResidualHead_decoder, ResidualHead_autoencoder
from losses import ClipLoss, SigLipLoss, AdMClipLoss
...
from utils import load_publications_data , load_atlas_masked
...
# lr_decoder = 3e-3 # for sigmoid non-negativity
...
alpha = 1e-0 # contrastive loss hyperparameter
...
reconstruction_model, reconstruction_train_loss, reconstruction_val_loss = single_input_train(
    ...
    optimizer=torch.optim.AdamW(
        ...
        # lr=3e-3, # for sigmoide non-negativity
        lr=1e-4,
        weight_decay=weight_decay,
    ),
    scheduler=None,
